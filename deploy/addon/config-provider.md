...
{{< image "/images/schema-config-provider-02.png" "Tho Node.js applications sharing the 2 variables from a configuration provider" "max-width: 900px" >}}
...
You can find out more about rules and format in [this page](https://www.clever-cloud.com/doc/develop/env-variables/#environment-variables-rules-and-formats).
